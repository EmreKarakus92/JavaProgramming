...
public class ArrayUtilities {
    ...
    public static int[] removeElement(int[] arrayArg, int indexArg) {
        ...
        for (int i = 0; i < arrayArg.length; i++) {
            if (!(i == indexArg)) {
                removedArray = ArrayUtilities.addsElement(removedArray, arrayArg[i]);
            }
        }
        return removedArray;
    ...
    //swaps two elements of int Array based on given index numbers. --input: int[] array, int index1, int index2 output:int[] array
    public static int[] swapsElements(int[] arrayArg, int index1Arg, int index2Arg){

        if(index1Arg<0 || index1Arg>arrayArg.length-1)
            System.exit(0);
        if(index2Arg<0 || index2Arg>arrayArg.length-1)
            System.exit(0);
        
        int[] newArray = {};
        for (int i = 0; i < arrayArg.length; i++) {
            if(!(i==index1Arg || i==index2Arg)){
                newArray = addsElement(newArray, arrayArg[i]);
            } else if (i==index1Arg) {
                newArray = addsElement(newArray, arrayArg[index2Arg]) ;
            } else newArray = addsElement(newArray, arrayArg[index1Arg]) ;
        }
        return newArray ;
    }

    //swaps two elements of double Array based on given index numbers. --input: double[] array, int index1, int index2 output:double[] array
    public static double[] swapsElements(double[] arrayArg, int index1Arg, int index2Arg){
    ...
    //swaps two elements of char Array based on given index numbers. --input: char[] array, int index1, int index2 output:char[] array
    public static char[] swapsElements(char[] arrayArg, int index1Arg, int index2Arg){
    ...
    //swaps two elements of String Array based on given index numbers. --input: String[] array, int index1, int index2 output:String[] array
    public static String[] swapsElements(String[] arrayArg, int index1Arg, int index2Arg){
    ...
    //creates an int array. --input:  --output: int[] array
    public static int[] createAIntArray(){
    ...
    //creates an double array. --input:  --output: double[] array
    public static double[] createADoubleArray(){
        System.out.println("Please enter the length of Array.");
        Scanner input = new Scanner(System.in) ;
        int lengthOfArray = input.nextInt();
    ...
    //creates an String array. --input:  --output: String[] array
    public static String[] createAStringArray(){
        System.out.println("Please enter the length of Array.");
        Scanner input = new Scanner(System.in) ;
        int lengthOfArray = input.nextInt();
    ...
    //creates an char array. --input:  --output: int[] char
    public static char[] createAnCharArray(){
        System.out.println("Please enter the length of Array.");
        Scanner input = new Scanner(System.in) ;
        int lengthOfArray = input.nextInt();
        char[] array = new char[lengthOfArray] ;
        for (int i = 0; i < lengthOfArray ; i++) {
            System.out.println("Please enter the " + (i+1) +". element of the Array");
