...
Add A constructor that can set all the fields
		...
		6.3 Create a class called Server
	            ...
	            Actions: (all void methods)
	                ...
	                toString(): Return (String) of all the information of a Server object. No need to print the whole list of Servers or Chefs. Print the number of Servers and Chefs along side the other information


		6.4. Create a class LocalRestaurant that has a main method with the following:
	        	- Make a Server object
	        	- Create an array of servers with their information set. Add those initial servers to the ArrayList of Servers in the Server object
	            - Create an array of chefs with their information set. Add those initial chefs to the ArrayList of Chefs in the Server object
